...
- 場地租借：進入教室租借頁面，使用者可透過搜尋選取出想預約的日期以及人數，搜尋後下方顯現出還未被預約的教室，免除使用者點入所想租借之教室後，卻發現已額滿的窘境。點擊想預約的教室後，右邊可以看到詳細教室資訊，左邊可以選取自己想預約的時段、人數與日期，選取完畢後可以一目了然的看到價格，點擊預約按鈕就能加入購物車等待付款。
